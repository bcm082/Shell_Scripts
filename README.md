...
5. [Remane File Extension in a Folder](https://github.com/bcm082/bash_scripts/blob/main/5-Rename_File_Extensions.sh)
6. [Shell script takes user input to an array, pass to a function to return the sum of numbers](https://github.com/bcm082/bash_scripts/blob/main/6-array-function.sh)
