...
3. [Shell script display_even_digits that takes a number as input and use while loop to display all the even digits within that number. ex input: 10 output: 2 4 6 8 10](1.2-While_Do_Loop.shhttps://github.com/bcm082/bash_scripts/blob/main/1.2-While_Do_Loop.sh)
